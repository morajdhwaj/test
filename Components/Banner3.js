function Banner3() {
  return (
    <div className="flex justify-center items-center  pt-20 sm:pt-72">
      <div className="w-11/12 h-auto  flex ">
        <div className=" w-1/2 h-auto ">
            <div className=" h-10 sm:flex sm:justify-center sm:items-center ">
          ...
          <div className=" bg-gradient-to-r from-[#21262d] to-[rgba(33, 38, 45, 0)] flex-1  h-[1px] "></div>
            ...
            <div className=" h-auto flex">
                <div className=" w-20   h-full   pt-5 pl-2 ">
                <div className="border border-white rounded-full sm:flex sm:justify-center sm:items-center text-white bg-[#097068] h-14 w-14  shadow-[rgb(127,137,236,0.4)] shadow-[0_5px_30px_0.1px_rgba(46,23,255,0.1)]   ">
            ...
            <p className="text-secondry text-xl pt-4 ">
        ...
        <div className="   sm:flex items-end pb-12 ml-28 ">
            <div className="bg-gray-800 rounded-lg w-60 h-44 sm:flex sm:justify-center sm:items-center">
                <div className="bg-gray-700 rounded-lg w-48 h-32   ">
        ...
        <div className="sm:flex sm:flex-col sm:justify-center  pl-5 pt-36 ">
            ...
            <p className=" text-secondry pr-28">Use this text to describe the first step...</p>
